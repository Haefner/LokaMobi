...
import static androidx.room.ForeignKey.CASCADE;
    ...
    public class MagnetometerEvent implements Event {
        ...
        public MagnetometerEvent() {
        }

        public MagnetometerEvent(long recordId,@NonNull Float x, @NonNull Float y, @NonNull Float z, @NonNull Long timestamp) {
            this.x = x;
            this.y = y;
            this.z = z;
        ...
        @Ignore
        public MagnetometerEvent(@NonNull Float x, @NonNull Float y, @NonNull Float z, @NonNull Long timestamp) {
            this.x = x;
            this.y = y;
            this.z = z;
            this.timestamp = timestamp;
