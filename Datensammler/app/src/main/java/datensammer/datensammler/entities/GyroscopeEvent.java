...
public class GyroscopeEvent implements Event {
    ...
    public GyroscopeEvent(long recordId,@NonNull Float x, @NonNull Float y, @NonNull Float z, @NonNull Long timestamp) {
        this.x = x;
        this.y = y;
        this.z = z;
    ...
    @Ignore
    public GyroscopeEvent(@NonNull Float x, @NonNull Float y, @NonNull Float z, @NonNull Long timestamp) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.timestamp = timestamp;
